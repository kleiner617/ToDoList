...
import com.jhipster.todo.repository.CategoryRepository;
import com.jhipster.todo.repository.UserRepository;
import com.jhipster.todo.repository.search.CategorySearchRepository;
...
public class CategoryResource {
    ...
    public ResponseEntity<Category> createCategory(@Valid @RequestBody Category category) throws URISyntaxException {
        ...
        if (!SecurityUtils.isCurrentUserInRole(AuthoritiesConstants.ADMIN)) {
            log.debug("No user passed in, usering current user: {}", SecurityUtils.getCurrentUserLogin());
            category.setUser(userRepository.findOneByLogin(SecurityUtils.getCurrentUserLogin()).get());
        }
    ...
    public ResponseEntity<List<Category>> getAllCategories(Pageable pageable)
        ...
        if (userOptional.isPresent()) {
            Page<Category> page = categoryRepository.findByUser(pageable, userOptional.get());
